...
- `low pogo hops` `1x10`
- `single-leg glute bridge` `1x6/side`
- `2 progressive ramp-up sets` on the main lift
...
### Block 1 - Back Three Power Cluster
- Format: `4 rounds`, `10-15s` between exercises, full rest `3-4 min` after each round
- Exercise A: `Trap Bar Deadlift` `4x2-3 @ 80-85%`
- Exercise B: `Broad Jump` `3 reps`
- Exercise C: `Band-Assisted Split Jump` `2-3/side`
- Coaching notes:
