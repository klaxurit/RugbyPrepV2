...
export const APP_LABELS = {
  ...
  step3_section_ffr_club: { fr: 'Ton club FFR', en: 'Your FFR club' },
  step3_ffr_club_placeholder: { fr: 'Rechercher un club FFR…', en: 'Search an FFR club…' },
  step3_ffr_club_hint: {
    fr: 'Optionnel — tu importeras tes matchs ensuite dans le profil.',
    en: 'Optional — you can import matches later in your profile.',
  },
  step3_section_next_match: { fr: 'Prochain match', en: 'Next match' },
  step3_next_match_hint: {
    fr: 'Optionnel — pour caler ta semaine sans attendre le calendrier. Aucun match n’est inventé.',
    en: 'Optional — to place your week without waiting for the calendar. No match is invented.',
  },
  ...
  step5_row_club: { fr: 'Club', en: 'Club' },
  ...
  profile_section_preferences_sub: { fr: 'Langue, morphologie et actualités', en: 'Language, body metrics and news' },
  profile_section_newsletter: { fr: 'Actualités RugbyForge', en: 'RugbyForge news' },
  profile_section_newsletter_sub: {
    fr: 'Maj de l’app et conseils de prépa rugby. Pas de publicité.',
    en: 'App updates and rugby S&C tips. No ads.',
  },
  profile_section_newsletter_on: { fr: 'Inscrit', en: 'Subscribed' },
  profile_section_newsletter_off: { fr: 'Non inscrit', en: 'Unsubscribed' },
  password_min_placeholder: { fr: '10 caractères minimum', en: '10 characters minimum' },
  password_upgrade_aria: { fr: 'Mise à jour du mot de passe', en: 'Password update' },
  password_upgrade_eyebrow: { fr: 'Sécurité du compte', en: 'Account security' },
  password_upgrade_title: { fr: 'Ton mot de passe est trop court', en: 'Your password is too short' },
  password_upgrade_body: {
    fr: 'Pour protéger ton compte (abonnement, séances), il faut au moins 10 caractères. Une phrase de 3 mots marche très bien.',
    en: 'To protect your account (subscription, sessions), use at least 10 characters. A 3-word phrase works well.',
  },
  password_upgrade_new: { fr: 'Nouveau mot de passe', en: 'New password' },
  password_upgrade_confirm: { fr: 'Confirmer le mot de passe', en: 'Confirm password' },
  password_upgrade_confirm_placeholder: { fr: 'Répète ton mot de passe', en: 'Repeat your password' },
  password_upgrade_mismatch: { fr: 'Les mots de passe ne correspondent pas.', en: 'Passwords do not match.' },
  password_upgrade_cta: { fr: 'Enregistrer', en: 'Save' },
  password_upgrade_saving: { fr: 'Enregistrement…', en: 'Saving…' },
  newsletter_prompt_aria: { fr: 'Inscription aux actualités RugbyForge', en: 'RugbyForge newsletter opt-in' },
  newsletter_prompt_eyebrow: { fr: 'Actualités RugbyForge', en: 'RugbyForge news' },
  newsletter_prompt_title: { fr: 'Tu veux les maj de l’app ?', en: 'Want app updates?' },
  newsletter_prompt_body: {
    fr: 'Pas de pubs, pas de partenaires. Uniquement des mises à jour de l’app et des conseils de prépa rugby. Désinscription en un clic.',
    en: 'No ads, no partners. Only app updates and rugby S&C tips. Unsubscribe in one click.',
  },
  newsletter_prompt_bullet_updates: { fr: 'Mises à jour de l’app', en: 'App updates' },
  newsletter_prompt_bullet_training: { fr: 'Conseils de prépa physique rugby', en: 'Rugby S&C tips' },
  newsletter_prompt_bullet_ads: { fr: 'Aucune publicité, aucun partenaire', en: 'No ads, no partners' },
  newsletter_prompt_accept: { fr: 'Oui, tenez-moi au courant', en: 'Yes, keep me posted' },
  newsletter_prompt_decline: { fr: 'Non merci', en: 'No thanks' },
  newsletter_prompt_saving: { fr: 'Enregistrement…', en: 'Saving…' },
  signup_newsletter_label: {
    fr: 'J’accepte de recevoir les actualités RugbyForge (mises à jour de l’app, conseils de prépa rugby). Pas de publicité. Je pourrai me désinscrire à tout moment.',
    en: 'I agree to receive RugbyForge news (app updates, rugby S&C tips). No ads. I can unsubscribe at any time.',
  },
