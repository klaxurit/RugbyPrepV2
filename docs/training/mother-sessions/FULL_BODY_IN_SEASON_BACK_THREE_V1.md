...
- `scap push-up` `1x8`
- `2 progressive prep sets` on the first loaded movement
...
- Exercise C: `Copenhagen Hold` `20-30s`
- Coaching notes:
...
### Optional Block 5 - Arm Pump / Reward Block
- Format: `2-3 rounds`, `45-60s` rest
- Exercise A: `Alternating DB Curl` `10-12 reps`
- Exercise B: `Skull Crusher` `10-12 reps`
- Coaching notes:
  - Optional only.
