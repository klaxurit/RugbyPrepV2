...
- `scap push-up` `1x8`
- `2-3 progressive ramp-up sets` on the first loaded movement
...
### Block 1 - Full-Body Force-Projection Pair
- Format: `3 rounds`, full rest `3 min` after each round
- Exercise A: `Trap Bar Deadlift` `3x3 @ 82-85%`
...
- Exercise A: `DB Incline Bench Press` `3x6`
...
- Exercise B: `Copenhagen Hold` `15-20s/side`
- Coaching notes:
