...
export function EmptyArtInvite({ size }: ArtProps) {
  return (
    <Frame size={size}>
      ...
      <path
        d="M62 90 c2-12 10-20 16-20 4 0 8 2 11 6"
        stroke={STROKE}
        strokeWidth={2.2}
        strokeDasharray="3 3"
        strokeLinecap="round"
