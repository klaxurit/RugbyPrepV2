...
- `push-up` `1x8`
- `2-3 progressive ramp-up sets on bench` ``
...
### Block 1 - Press Force + Speed Contrast
- Format: `4 rounds`, `3-4 min` rest
- Exercise A: (prime) `bench press` `4x4-5 @ 85%`
...
- Exercise A: `neutral-grip pull-up` `4x4-5`
...
- Exercise A: `half-kneeling landmine press` `3x4-5/side`
- Exercise B: `half-kneeling cable row` `3x5-6/side`
- Coaching notes:
