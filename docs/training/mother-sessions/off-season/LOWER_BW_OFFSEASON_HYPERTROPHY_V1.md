...
- `glute bridge` `1x8`
- `bodyweight split squat` `1x6/side`
...
- Exercise A: `Bulgarian Split Squat` `5x8-10/side @ RER 1-2`
- Coaching notes:
...
- Exercise A: `Nordic Eccentric` `4x6-8 @ RER 1-2`
- Exercise B: `Reverse Lunge Bodyweight` `5x8-10/side @ RER 1-2`
- Coaching notes:
...
- Exercise A: `Kickstand RDL` `2x10-12/side @ RER 1-2`
...
- Exercise A: `Single-Leg Calf Raise` `2x10-12/side @ RER 1-2`
- Exercise B: `Wall Tibialis Raise` `2x12-15 @ RER 1-2`
- Coaching notes:
