...
- `adductor rock-back` `1x8/side`
- `wall drill march` `1x6/side`
- `A-skip` `1x10m`
- `pogo hops` `1x10`
- `2 progressive rehearsal reps` on the first acceleration drill
...
- Exercise A: `Resisted Acceleration` `8-10m`
- Exercise B: `Free Acceleration Sprint` `10-20m`
- Coaching notes:
...
### Block 2 - Structured Plyometric Cluster
- Format: `3 rounds`, full rest `90-120s`
- Exercise A: `Countermovement Jump` `2-3 reps`
...
### Block 3 - Upper Ballistic Pair
- Format: `3 rounds`, full rest `90-120s`
- Exercise A: `Med Ball Chest Pass` `4 reps`
- Exercise B: `Med Ball Rotational Throw` `3/side`
- Coaching notes:
...
### Block 4 - COD / Athletic Change of Direction
- Format: `2 drills`, `3-4 reps` each, full rest `60-90s`
- Exercise A: `5-10-5 Shuttle`
- Exercise B: `Reactive Start to 45-Degree Cut`
- Coaching notes:
...
### Block 5 - Optional Lower-Leg Support
- Format: `1-2 rounds`, `30-45s` rest
- Exercise A: `Single-Leg Calf Raise` `10-12/side`
- Exercise B: `Wall Tibialis Raise` `12-15 reps`
- Coaching notes:
