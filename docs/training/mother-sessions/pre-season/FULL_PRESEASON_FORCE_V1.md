...
- Exercise A: `Trap Bar Deadlift` `3x5 @ RER 1-2`
- Coaching notes:
...
- Exercise A: `Parallel Bar Dip` `3x6-8 @ RER 1-2`
...
- Exercise B: `Landmine Rotation` `2-3x6-8/side @ RER 1-2`
- Coaching notes:
...
- Exercise B: `Copenhagen Hold` `20-30s/side`
- Coaching notes:
