...
| Rail J-2 runtime | Date séance ∈ [J-2, match] (jours calendaires) → `variant: light` au placement + render. Pas de rewrite mother. Sans event match → rien. | — | Fenêtre 48 h depuis midi (rate le jeudi) / light hors calendrier réel |
