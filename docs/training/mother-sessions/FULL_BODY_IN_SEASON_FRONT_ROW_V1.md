...
- Exercise A: `Sled Push` `15-20m`
- Exercise B: `Copenhagen Hold` `20-30s`
- Exercise C: `Neck Isometric` `15-20s`
- Coaching notes:
...
- Format: `2-3 rounds`, `45-60s` rest
- Exercise A: `Hammer Curl` `10-12 reps`
- Exercise B: `French Press` `10-12 reps`
- Coaching notes:
  - Optional only.
