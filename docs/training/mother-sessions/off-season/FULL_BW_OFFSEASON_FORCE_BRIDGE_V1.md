...
- Exercise A: `Kickstand RDL` `3x4-5/side @ RER 1-2`
...
- Exercise B: `Single-Leg Glute Bridge` `3x6/side @ RER 1-2`
- Coaching notes:
...
- Exercise A: `Bear Crawl` `2x20m`
- Exercise B: `Side Plank` `2x15-30s/side`
- Coaching notes:
