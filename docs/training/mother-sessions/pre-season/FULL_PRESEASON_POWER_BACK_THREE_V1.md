...
- `thoracic rotation` `1x6/side`
- `scap push-up` `1x8`
- `2 progressive ramp-up sets` on the first loaded movement
...
- Exercise A: `Front Squat` `3x2-3 @ 78-82%`
...
### Block 4 - Lower Leg / Groin Support
- Format: `2-3 rounds`, `45-60s` rest
- Exercise A: `Weighted Calf Raise` `10-12 reps`
- Exercise B: `Tibialis Raise` `10-12 reps`
- Exercise C: `Copenhagen Hold` `15-20s/side`
- Coaching notes:
