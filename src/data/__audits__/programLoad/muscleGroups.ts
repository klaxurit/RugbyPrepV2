...
export const EXERCISE_MUSCLE_MAP: Readonly<Record<string, Contribution>> = {
  ...
  'farmer walk (backpack)': { trunk: 1, back: 0.5 },
  'farmer walk sac à dos': { trunk: 1, back: 0.5 },
  'farmer walk (marche du fermier)': { trunk: 1, back: 0.5 },
  'marche du fermier': { trunk: 1, back: 0.5 },
