...
### Recommended warm-up
- `thoracic rotation` `1x8/side`
- `scap push-up` `1x8-10`
- `band pull-apart` or `TYI light` `1-2x10`
- `2 progressive ramp-up sets` on the main press
...
### Block 1 - Front Row Upper Power Cluster
- Format: `4 rounds`, `10-15s` between exercises, full rest `3-4 min` after each round
- Exercise A: `Football Bar Bench Press` `4x3 @ 80-85%`
- Exercise B: `Supine Med Ball Throw` `3 reps`
- Exercise C: `Plyo Push-Up` `3-4 reps`
- Coaching notes:
...
### Block 3 - Secondary Pull Support
- Format: `2 work sets`, `90-120s` rest between sets
- Exercise A: `T-Bar Row` `2x5-6`
- Coaching notes:
...
- Format: `EMOM 6'`
- Exercise A: minute 1 `Zercher Carry` or `Farmer Carry` `20m`
- Exercise B: minute 2 `Med Ball Rotational Throw` `3-4/side`
- Coaching notes:
...
- Exercise C: `Scap Push-Up` `8-10 reps`
- Coaching notes:
