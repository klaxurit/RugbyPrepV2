...
- `glute bridge` `1x8`
- `bodyweight squat` `1x8`
- `2 progressive ramp-up sets` on the main squat
...
### Block 1 - Front Row Power Cluster
- Format: `4 rounds`, `10-15s` between exercises, full rest `3-4 min` after each round
- Exercise A: `Box Squat` `4x3 @ 85-88%`
- Exercise B: `Banded Kettlebell Swing` `4-5 reps`
- Exercise C: `Countermovement Jump` `3 reps`
- Coaching notes:
...
- Format: `EMOM 6'`
- Exercise A: minute 1 `Sled Push` `15-20m`
