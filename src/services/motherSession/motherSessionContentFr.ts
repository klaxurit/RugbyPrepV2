...
const SESSION_CONTENT_FR: Record<string, SessionContentFr> = {
  ...
  LOWER_OFFSEASON_HYPERTROPHY_V1: {
    ...
    progressionRules: [
      '`Semaine 1` : démarre en bas de fourchette de charge pour valider la tolérance au volume.',
      '`Semaine 2` : monte la charge seulement si la récup est bonne, en gardant l\'unilatéral à `3 séries`.',
      '`Semaine 3` : semaine la plus volumineuse — séries dures autorisées (`1-2 reps en réserve`) en gardant la qualité.',
      '`Semaine 3` : passe l\'unilatéral à `4 séries` uniquement si la récup le permet.',
      '`Semaine 4 (décharge)` : réduis le volume total de `25 à 30%` en gardant une charge utile.',
      'Si la fatigue monte, retire en premier les exercices optionnels du Bloc 4 (`Leg Extension` + `Calf Press`).',
      'Puis retire un tour du Bloc 3.',
      'Garde les Blocs 1 et 2 comme priorités structurelles.',
    ],
    positionAccent: [
      'Cette séance reste majoritairement commune aux deux groupes.',
      'Si tu es en première ligne : un peu plus de gainage volontaire sur squat et RDL, et un peu plus de patience et de contrôle sur l\'unilatéral.',
      'Si tu es ailier ou arrière : un peu plus de fluidité et d\'amplitude sur l\'unilatéral, et un peu plus d\'attention à la qualité chaîne basse au Bloc 4.',
    ...
    coachingWarnings: [
      ...
      'Ne transforme pas les blocs de soutien en volume de remplissage sans réflexion.',
  ...
  UPPER_OFFSEASON_HYPERTROPHY_V1: {
    ...
    progressionRules: [
      '`Semaine 1` : démarre en bas de fourchette de charge pour valider la tolérance au volume.',
      '`Semaine 2` : monte la charge seulement si poussée et tirage récupèrent bien, en gardant la poussée secondaire à `3 séries`.',
      '`Semaine 3` : semaine la plus volumineuse — séries dures mais propres autorisées (`1-2 reps en réserve`).',
      '`Semaine 3` : passe `Incline DB Bench Press` à `4 séries` uniquement si la récup le permet.',
      '`Semaine 4 (décharge)` : réduis le volume total de `25 à 30%` en gardant une charge utile.',
      'Si la fatigue monte, retire en premier les exercices optionnels du Bloc 4 (`Lateral Raise` + `T-Y-I`).',
      'Puis retire un tour du Bloc 3.',
      'Garde les Blocs 1 et 2 comme priorités structurelles.',
    ],
    positionAccent: [
      'Cette séance reste majoritairement commune aux deux groupes.',
      'Si tu es en première ligne : un peu plus de gainage et de contrôle sur bench et développé, et un peu plus d\'intérêt pour l\'épaisseur bras et support.',
      'Si tu es ailier ou arrière : un peu plus de fluidité dans le rythme poussée/tirage, et un peu plus d\'attention à la liberté d\'épaule et à la posture.',
      'La structure reste identique pour les deux groupes.',
    ],
    coachingWarnings: [
  ...
  FULL_OFFSEASON_HYPERTROPHY_V1: {
    ...
    blocks: [
      ...
      {
        name: 'Finisher rugby',
        format: '`2 tours`, `45-60s` de repos après le tour',
        exercises: [
          { name: 'Farmer Carry', prescription: '2x30s' },
          { name: 'Copenhagen Plank', prescription: '2x20-30s/côté' },
          { name: 'Banded Neck Isometric', prescription: '2x10s/direction' },
        ],
        coachingNotes: [
    ...
    progressionRules: [
      '`Semaine 1` : démarre en bas de fourchette de charge pour valider la tolérance hebdomadaire.',
    ...
    positionAccent: [
      'Cette séance reste majoritairement commune aux deux groupes.',
      'Si tu es en première ligne : un peu plus de gainage et de posture sur trap bar et fente, et un peu plus d\'intérêt pour le travail support/tronc.',
      'Si tu es ailier ou arrière : un peu plus de fluidité et d\'amplitude sur fente et bas de jambe, et un peu plus d\'attention à la qualité de mouvement qu\'à la charge brute.',
      'La structure reste identique pour les deux groupes.',
    ],
    coachingWarnings: [
  ...
  LOWER_OFFSEASON_HYPERTROPHY_BACK_THREE_V1: {
    ...
    progressionRules: [
      '`Semaine 1` : valide une tolérance au volume propre sur tous les exercices.',
      '`Semaine 2` : monte la charge si la récup est bonne ; garde le nordic à 4-5 reps.',
      '`Semaine 3` : semaine la plus volumineuse ; effort `RPE 7-8` autorisé sur les mouvements principaux.',
      '`Semaine 4 (décharge)` : réduis le volume `25 à 30%` en gardant la charge. Réduis le Bloc 4 en premier, le Bloc 3 ensuite.',
    ],
    positionAccent: [
  ...
  UPPER_OFFSEASON_HYPERTROPHY_BACK_THREE_V1: {
    ...
    progressionRules: [
      '`Semaine 1` : établis la forme sur landmine press et single-arm row.',
      '`Semaine 2` : monte les charges si la forme est propre.',
      '`Semaine 3` : volume max ; `RPE 7-8` autorisé.',
      '`Semaine 4 (décharge)` : réduis `25 à 30%`. Retire med ball throws et face pull en premier.',
    ],
    positionAccent: [
  ...
  FULL_OFFSEASON_HYPERTROPHY_BACK_THREE_V1: {
    ...
    progressionRules: [
      '`Semaine 1` : établis la forme sur landmine et lancers rotationnels.',
      '`Semaine 2` : monte les charges ; garde les lancers à 4/côté.',
      '`Semaine 3` : volume max. `RPE 7-8`.',
