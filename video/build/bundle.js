...
const screens_namespaceObject = /*#__PURE__*/JSON.parse('{"_p":{"id":"PromoVertical","width":1080,"height":1920,"fps":30,"transitionFrames":18},"wk":{"name":"RugbyForge","eyebrow":"Preparation physique rugby","tagline":"Ta prepa physique, scientifiquement optimisee","subline":"Programmes periodises, charge ACWR, prevention blessures et coach IA.","cta":"Commencer gratuitement"},"Lv":{"duration":84,"logoPath":"assets/branding/rugbyprep-logo.png","stats":[{"value":"186+","label":"references"},{"value":"88","label":"blocs"},{"value":"12","label":"semaines"}]},"mb":[{"id":"week","eyebrow":"Programme intelligent","title":"Ta semaine est deja structuree","description":"Seances, fatigue et acces rapides dans un seul ecran pour avancer sans improviser.","imagePath":"assets/screens/app-week.png","duration":112,"accent":"#ff6b35","secondary":"#1a5f3f","chips":["Cycle adapte","Fatigue suivie","Saison active"],"kicker":"Tout commence par un plan clair."},{"id":"acwr","eyebrow":"Charge maitrisee","title":"Repere la zone de risque avant la blessure","description":"Le suivi ACWR t\'aide a ajuster le volume quand la charge grimpe trop vite.","imagePath":"assets/screens/acwr-monitoring.png","duration":112,"accent":"#ff6b35","secondary":"#d92d20","chips":["ACWR en direct","Alerte surcharge","Decision simple"],"kicker":"Moins de doute. Plus de controle."},{"id":"progress","eyebrow":"Progression visible","title":"Transforme chaque seance en donnees utiles","description":"Suis tes PR, tes tests et ta progression saison apres saison dans la meme app.","imagePath":"assets/screens/tests-progression.png","duration":112,"accent":"#16a34a","secondary":"#0f766e","chips":["PR suivis","Tests physiques","Objectifs lisibles"],"kicker":"La progression devient concrete."},{"id":"calendar","eyebrow":"Semaine reelle","title":"Le calendrier club pilote ta preparation","description":"Matchs, entrainements et phase de saison influencent directement tes priorites.","imagePath":"assets/screens/calendar.png","duration":112,"accent":"#ff6b35","secondary":"#1a5f3f","chips":["Match a venir","Charge contextualisee","Semaine adaptee"],"kicker":"Ton programme vit avec ta saison."},{"id":"coach","eyebrow":"Coach IA","title":"Pose une question. Obtiens une reponse exploitable","description":"Nutrition, recuperation, sommeil ou prevention: l\'IA garde le contexte de ton profil.","imagePath":"assets/screens/ai-chat.png","duration":112,"accent":"#f97316","secondary":"#7c3aed","chips":["Questions du quotidien","Contexte de la semaine","Upsell premium"],"kicker":"Un assistant qui parle rugby."}],"Md":{"duration":90,"headline":"Passe au niveau superieur","subline":"Programme intelligent, charge maitrisee, progression visible.","cta":"Commencer gratuitement"}}');
;// ./src/compositions/PhoneFrame.tsx
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              esm.Img,
              {
                src: (0,esm.staticFile)(imagePath),
                style: {
                  width: "100%",
                  height: "100%",
                  objectFit: "cover"
...
;// ./src/compositions/PromoVertical.tsx





const { /* videoConfig */ "_p": videoConfig, /* brand */ "wk": brand, /* intro */ "Lv": intro, /* screens */ "mb": screens, /* outro */ "Md": outro } = screens_namespaceObject;
const TRANSITION_FRAMES = videoConfig.transitionFrames;
const buildSceneStarts = (durations) => {
  const starts = [];
  let cursor = 0;
...
const PROMO_DURATION = SCENE_DURATIONS.reduce((sum, duration) => sum + duration, 0) - TRANSITION_FRAMES * (SCENE_DURATIONS.length - 1);
const SCENE_FONT = '"Arial Black", Impact, sans-serif';
const BODY_FONT = '"Helvetica Neue", Arial, sans-serif';
const useSceneProgress = (durationInFrames) => {
  const frame = (0,esm.useCurrentFrame)();
  ...
  const contentY = (0,esm.interpolate)(frame, [0, 24], [42, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return { opacity, contentY };
};
const BackgroundShell = ({ accent, secondary, children }) => {
  const frame = (0,esm.useCurrentFrame)();
...
const Pill = ({ label, accent = "#ff6b35" }) => {
...
const IntroScene = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(BackgroundShell, { accent: "#ff6b35", secondary: "#1a5f3f", children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      style: {
        opacity,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              ...
              children: brand.eyebrow
            }
          ),
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { marginTop: 56, display: "flex", alignItems: "center", gap: 34 }, children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              esm.Img,
              {
                src: (0,esm.staticFile)(intro.logoPath),
                style: {
                  width: 250,
                  height: 250,
                  objectFit: "contain",
            ...
            /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  style: {
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              ...
              children: brand.subline
            }
          )
        ] }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", gap: 22 }, children: intro.stats.map((stat) => /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              flex: 1,
...
const PromoSlide = ({ screen, index }) => {
  const { opacity, contentY } = useSceneProgress(screen.duration);
  const frame = (0,esm.useCurrentFrame)();
  const tiltDeg = index % 2 === 0 ? -4 : 4;
  const badgeX = Math.sin(frame / 20) * 8;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(BackgroundShell, { accent: screen.accent, secondary: screen.secondary, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      style: {
        opacity,
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 28 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: screen.chips.map((chip) => /* @__PURE__ */ (0,jsx_runtime.jsx)(Pill, { label: chip, accent: screen.accent }, chip))
          }
        ),
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: screen.kicker
                }
              ),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(PhoneFrame, { imagePath: screen.imagePath, accent: screen.accent, tiltDeg })
            ]
          }
        )
      ]
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(Pill, { label: "Programme periodise" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(Pill, { label: "Charge maitrisee" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(Pill, { label: "Coach IA" })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
...
const PromoVertical = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#100705" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: SCENE_STARTS[0], durationInFrames: intro.duration, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(IntroScene, {}) }),
    screens.map((screen, index) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Sequence,
      {
        from: SCENE_STARTS[index + 1],
        durationInFrames: screen.duration,
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PromoSlide, { screen, index })
      },
      screen.id
    )),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Sequence,
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(OutroScene, {})
      }
    )
  ] });
};
...
const { /* videoConfig */ "_p": Root_videoConfig } = screens_namespaceObject;
const Root = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      id: Root_videoConfig.id,
      component: PromoVertical,
      durationInFrames: PROMO_DURATION,
      fps: Root_videoConfig.fps,
      width: Root_videoConfig.width,
      height: Root_videoConfig.height
    }
  );
};
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "rugbyprep-video:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrugbyprep_video"] = self["webpackChunkrugbyprep_video"] || [];
