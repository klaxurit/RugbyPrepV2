...
- `A-skip` `1x10m`
- `2 progressive rehearsal reps` on the first sprint start
...
- Exercise A: `Short Acceleration Sprint` `10-20m`
- Coaching notes:
...
### Block 2 - Jumps / Plyometrics
- Format: `3 rounds`, full rest `90-120s`
- Exercise A: `Countermovement Jump` `3 reps`
...
### Block 3 - Upper Ballistic / Explosive Trunk
- Format: `3 rounds`, full rest `90-120s`
- Exercise A: `Med Ball Chest Pass` `4-5 reps`
...
- Exercise C: `Short Copenhagen Hold` `15-20s/side`
- Coaching notes:
